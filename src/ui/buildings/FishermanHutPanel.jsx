...
export default function FishermanHutPanel({ data, onClose, destroyButton }) {
  ...
  const assign = (type) => FishermanHut.assignWorker(window.__phaserScene, data.rootX, data.rootY, type);
  const unassign = () => FishermanHut.unassignLastWorker(window.__phaserScene, data.rootX, data.rootY);
  const pickTile = () => {
    ...
    <div style={panelStyle}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <strong style={{ fontSize: 14 }}>Fisherman Hut</strong>
        </div>
      ...
      {/* Combined Warehouse & Water Tile Row */}
      ...
      <div style={{ marginBottom: 8 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 4 }}>
          ...
          <button 
            style={{
              ...(canAssignFisherman ? btnMinimalSmall : btnMinimalDisabled),
              fontSize: 9,
              padding: "4px 6px",
            }}
